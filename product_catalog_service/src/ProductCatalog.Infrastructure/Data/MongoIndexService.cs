...
namespace ProductCatalog.Infrastructure.Data
{
    public class MongoIndexService : IMongoIndexService
    {
        ...
        {
            var domainAssembly = typeof(ProductCatalog.Domain.Entities.Product).Assembly;
            var modelTypes = domainAssembly
                .GetTypes()
                .Where(t => t.IsClass && t.Namespace != null && t.Namespace.StartsWith("ProductCatalog.Domain.Entities"))
                .ToList();
